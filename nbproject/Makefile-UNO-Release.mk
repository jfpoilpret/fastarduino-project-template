...
LDLIBSOPTIONS=../fast-arduino-lib/dist/UNO-Release/AVR-GNU-Toolchain-3.5.3-Linux/libfastarduino.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fastpin1

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fastpin1: ../fast-arduino-lib/dist/UNO-Release/AVR-GNU-Toolchain-3.5.3-Linux/libfastarduino.a
...
# Subprojects
.build-subprojects:
	cd ../fast-arduino-lib && ${MAKE}  -f Makefile CONF=UNO-Release
...
# Subprojects
.clean-subprojects:
	cd ../fast-arduino-lib && ${MAKE}  -f Makefile CONF=UNO-Release clean
